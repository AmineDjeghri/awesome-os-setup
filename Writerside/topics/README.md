...
- Linux (Ubuntu 22.04): [unix_workflow/README](unix_workflow/0_unix_workflow_README.md).
  - can be used for Linux and WSL2.
- Windows 11 & WSL2: [windows_workflow/README](windows_workflow/0_windows_workflow_README.md).
   ...
   - WSL setup & Linux guides & automated scripts [unix_workflow/README](unix_workflow/0_unix_workflow_README.md) to automate the installation of essential components like terminal utilities, Conda, GPU drivers, and more.
