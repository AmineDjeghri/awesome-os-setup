...
- Configure your terminal to utilize the newly installed font. For Windows, check this [link](0_unix_workflow_README#23-dev-software--pycharm-sublime-text-windows-terminal-docker-desktop). For Linux ##TODO.
### 1.2. Run the script
