...
- If you are a linux/WSL user, you can jump directly to the dedicated section for Unix-based systems, tested on Ubuntu 22.04: [unix_workflow/0_linux_setup.md](unix_workflow/readme).
- If you are a Windows user, this repository encompasses
   ...
   - WSL setup & Linux guides & automated scripts [unix_workflow/0_linux_setup.md](unix_workflow/readme) to automate the installation of essential components like terminal utilities, Conda, GPU drivers, and more.
...
- [Linux Setup Guide](unix_workflow/readme) : contains an automated script & a tutorial to install the main elements I use in Linux/WSL.
...
Follow this tutorial [customize linuxwsl terminal](unix_workflow/readme) which includes an automated script to install the main elements I use in Linux/WSL.
