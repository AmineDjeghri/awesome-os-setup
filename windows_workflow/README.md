...
Follow this tutorial [customize linux_wsl terminal](../unix_workflow/README.md) which includes an automated script to install the main elements I use in Linux/WSL.
