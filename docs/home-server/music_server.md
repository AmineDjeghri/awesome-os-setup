...
in the [config.yaml](../../src/awesome_os/config/unix/home%20server%20and%20home%20assistant/beets/config.yaml) file (I disabled copy and move because i use Octo-Fiesta and i don't care about messing with the original files) :
...
#### Workflow:
- My [config.yaml](../../src/awesome_os/config/unix/home%20server%20and%20home%20assistant/beets/config.yaml)
